...
namespace AzureNetQ
{
    ...
    /// of routing topology, but keeping the AzureNetQ serialisation, persistent connection,
    ...
    public interface IAdvancedBus : IDisposable
    {
        ...
        /// connection. If there is a connection outage, AzureNetQ will not attempt to recreate
        /// consumers.
        /// </summary>
        /// <returns>The queue</returns>
        IQueue QueueDeclare();
        ...
        /// <summary>
        /// The IoC container that AzureNetQ uses to resolve it's services.
        /// </summary>
