...
namespace AzureNetQ.Consumer
{
    ...
    /// 
    /// Each exchange is bound to the central AzureNetQ error queue.
    /// </summary>
    public class DefaultConsumerErrorStrategy : IConsumerErrorStrategy
    {
        ...
        public virtual PostExceptionAckStrategy HandleConsumerError(ConsumerExecutionContext context, Exception exception)
        {
            ...
            catch (BrokerUnreachableException)
            {
                ...
                logger.ErrorWrite("AzureNetQ Consumer Error Handler cannot connect to Broker\n" +
            ...
            catch (OperationInterruptedException interruptedException)
            {
                ...
                logger.ErrorWrite("AzureNetQ Consumer Error Handler: Broker connection was closed while attempting to publish Error message.\n" +
            ...
            catch (Exception unexpectedException)
            {
                ...
                logger.ErrorWrite("AzureNetQ Consumer Error Handler: Failed to publish error message\nException is:\n"
                    + unexpectedException);
            }
        ...
        {
            return
                "Please check AzureNetQ connection information and that the RabbitMQ Service is running at the specified endpoint.\n" +
