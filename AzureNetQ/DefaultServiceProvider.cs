...
namespace AzureNetQ
{
    ...
    public class DefaultServiceProvider : IContainer
    {
        ...
        public virtual TService Resolve<TService>() where TService : class
        {
            ...
            {
                throw new AzureNetQException("No service of type {0} has been registered", serivceType.Name);
            }
            ...
            where TImplementation : class, TService 
        {
            ...
            {
                throw new AzureNetQException("Component {0} does not implement service interface {1}",
            ...
            {
                throw new AzureNetQException("An AzureNetQ service must have one and one only constructor. " +
