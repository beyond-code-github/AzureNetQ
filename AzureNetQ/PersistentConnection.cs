...
namespace AzureNetQ
{
    ...
    public class PersistentConnection : IPersistentConnection
    {
        ...
        public PersistentConnection(IConnectionFactory connectionFactory, IAzureNetQLogger logger, IEventBus eventBus)
        {
        ...
        {
            if(!IsConnected) throw new AzureNetQException("Not connected");
