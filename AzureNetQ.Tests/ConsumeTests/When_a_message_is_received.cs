...
namespace AzureNetQ.Tests.ConsumeTests
{
    [TestFixture]
    public class When_a_message_is_received
    {
        ...
        public void SetUp()
        {
            ...
            DeliverMessage("{ Text: \"Hello World :)\" }", "AzureNetQ.Tests.MyMessage:AzureNetQ.Tests");
            DeliverMessage("{ Text: \"Goodbye Cruel World!\" }", "AzureNetQ.Tests.MyOtherMessage:AzureNetQ.Tests");
            DeliverMessage("{ Text: \"Shoudn't get this\" }", "AzureNetQ.Tests.Unknown:AzureNetQ.Tests");
        }
