...
namespace AzureNetQ.Tests.Integration
{
    [TestFixture]
    public class RequestResponseTests
    {
        ...
        // First start the AzureNetQ.Tests.SimpleService console app.
        ...
        {
            const string routingKey = "AzureNetQ_Tests_TestRequestMessage:AzureNetQ_Tests_Messages";
        ...
        {
            const string routingKey = "AzureNetQ_Tests_TestAsyncRequestMessage:AzureNetQ_Tests_Messages";
            const string type = "not_the_type_you_are_expecting";
        ...
        // First start the AzureNetQ.Tests.SimpleService console app.
        // Run this test. You should see the SimpleService report that it's
        // Thrown, a new error message in the error queue and an AzureNetQResponderException
        // exception should be thrown by the consumer as a response.
        [Test, Explicit("Needs a Rabbit instance on localhost to work")]
        [ExpectedException(ExpectedException = typeof(AzureNetQResponderException), ExpectedMessage = "This should be the original exception message!")]
