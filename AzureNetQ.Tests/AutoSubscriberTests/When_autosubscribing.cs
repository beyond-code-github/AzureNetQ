...
namespace AzureNetQ.Tests.AutoSubscriberTests
{
    [TestFixture]
    public class When_autosubscribing
    {
        ...
        private const string expectedQueueName1 =
            "AzureNetQ.Tests.AutoSubscriberTests.When_autosubscribing+MessageA:AzureNetQ.Tests_my_app:d7617d39b90b6b695b90c630539a12e2";

        private const string expectedQueueName2 =
            "AzureNetQ.Tests.AutoSubscriberTests.When_autosubscribing+MessageB:AzureNetQ.Tests_MyExplicitId";

        private const string expectedQueueName3 =
            "AzureNetQ.Tests.AutoSubscriberTests.When_autosubscribing+MessageC:AzureNetQ.Tests_my_app:8b7980aa5e42959b4202e32ee442fc52";

        [SetUp]
        public void SetUp()
        {
            mockBuilder = new MockBuilder();
//            mockBuilder = new MockBuilder(x => x.Register<IAzureNetQLogger, ConsoleLogger>());
