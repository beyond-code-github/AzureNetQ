...
namespace AzureNetQ.Tests.ProducerTests
{
    [TestFixture]
    public class When_a_request_is_sent_but_an_exception_is_thrown_by_responder
    {
        ...
        [Test]
        [ExpectedException(ExpectedException = typeof(AzureNetQResponderException))]
        public void Should_throw_an_AzureNetQResponderException()
        {
            try
            {
        ...
        [Test]
        [ExpectedException(ExpectedException = typeof(AzureNetQResponderException), ExpectedMessage = "Why you are so bad with me?")]
        public void Should_throw_an_AzureNetQResponderException_with_a_specific_exception_message()
        {
            try
            {
                var task = mockBuilder.Bus.RequestAsync<TestRequestMessage, TestResponseMessage>(requestMessage);
        ...
        protected void DeliverMessage(string correlationId, string exceptionMessage)
        {
            ...
            {
                Type = "AzureNetQ.Tests.TestResponseMessage:AzureNetQ.Tests.Messages",
