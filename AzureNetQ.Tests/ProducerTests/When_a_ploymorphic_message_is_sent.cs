...
namespace AzureNetQ.Tests.ProducerTests
{
    ...
    public class When_a_ploymorphic_message_is_sent
    {
        ...
        private const string interfaceTypeName = "AzureNetQ.Tests.ProducerTests.IMyMessageInterface:AzureNetQ.Tests";
        private const string implementationTypeName = "AzureNetQ.Tests.ProducerTests.MyImplementation:AzureNetQ.Tests";
